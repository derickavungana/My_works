...
def main():
    ...
    with sync_playwright() as play:
        ...
        try:
            ...
            # Refresh the bank list before searching for deletion
            print(f"➤ Refreshing bank list before deletion...")
            refresh_bank_list(page)

            # Delete the bank
            print(f"➤ Searching for bank '{bank_name}' to delete...")
            deletion_started = delete_bank(page, bank_name)
            if deletion_started:
                ...
                if deletion_confirmed:
                    print(f"✓ Bank '{bank_name}' deleted successfully\n")
                else:
